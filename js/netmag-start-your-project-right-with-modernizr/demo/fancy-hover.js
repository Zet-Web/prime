var fancyHover = function () {
    ...
    var init = function (parentUL) {
        ...
        $('li', parentUL).hover(
            function () {
                $('figcaption', this).show().animate({ 'bottom': '0px', 'opacity': 1 }, 'fast', 'easeOutQuart');
            },
            function () {
                $('figcaption', this).animate({ 'bottom': '-50px', 'opacity': 0 }, 'fast', 'easeInQuart');
            }
        );
    }
    ...
    function goGrayscale(parentUL, fadeInSpeed, fadeOutSpeed) {
            ...
            fadeInSpeed = fadeInSpeed == null ? 200 : fadeInSpeed; //checks if fadeInSpeed was passed in the fuction call, if not, sets default
            fadeOutSpeed = fadeOutSpeed == null ? 300 : fadeOutSpeed; //checks if fadeOutSpeed was passed in the fuction call, if not, sets default
